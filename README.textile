...
Mostfit is available under the GNU AFFERO GENERAL PUBLIC LICENSE version 3. You should have received a file named COPYING along with Mostfit. COPYING is the complete text of the GNU Affero General Public License version 3. If not, see [[http://www.gnu.org/licenses/]].
