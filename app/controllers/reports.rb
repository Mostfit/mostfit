class Reports < Application
  ...
  def show(report_type, id)
    ...
    if Reports::Types.include?(klass)
      ...
      elsif [LateDisbursalsReport, LoanPurposeReport, ClientOccupationReport, DelinquentLoanReport, ParByCenterReport, ClientAbsenteeismReport, LoanSizePerManagerReport, GeneralLedgerReport, TrialBalanceReport].include?(klass)
