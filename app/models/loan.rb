class Loan
  ...
  def self.from_csv(row, headers)
    obj = new(:product => LoanProduct.first(:name => row[headers[:product]]).id, :amount => row[headers[:amount]], :interest_rate => row[headers[:interest_rate]], 
              ...
              :funding_line_id => FundingLine.first(:name => row[headers[:funding_line]]).id,
              :applied_by_staff_id => StaffMember.first(:name => row[headers[:applied_by_staff_id]]).id,
              :approved_by_staff_id => StaffMember.first(:name => row[headers[:approved_by_staff_id]]).id,
