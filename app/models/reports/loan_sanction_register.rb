class LoanSanctionRegister < Report
  ...
  def generate
    ...
    Loan.all(hash).each{|l|
      ...
      data[branch][center][groups[l.client.client_group_id]] ||= []
      data[branch][center][groups[l.client.client_group_id]].push([client.reference, client.name, client.spouse_name, 
