...
describe Regions, "Check region" do
  ...
  it "create a new area" do
    ...
    params          = {}
    params[:region] = {
      :name => "TestRegion", :manager_id => @staff_member.id, :address => " Adrash nagar", :contact_number => "9867453423",
      :landmark => "near Central jail", :creation_date => { "month" => "4", "day" => "3", "year" => "2009"}
    } 
