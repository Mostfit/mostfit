...
#   end
  ...
  it "(TESTCASE11)Loan product of 50k & interest rate 10%-15%, 1k-10k interest 15%, 11k-25k interest 12.5% & 26k-50k interest 10%" do
    ...
    h = {:name => :should_disburse_loan_with_different_limit_and_interest_rate, :model_name => Loan, :on_action => :update,
      :precondition => { :var1 => "amount", :var2 => 0, :binaryoperator => "", :comparator => :less_than_equal, :const_value => 50000,:linking_operator => :and },
      :precondition1 => { :var1 => "interest", :var2 => 0, :binaryoperator => "", :comparator => :greater_than_equal, :const_value => 0.10, :linking_operator => :and },
      :precondition2 => { :var1 => "interest", :var2 => 0, :binaryoperator => "", :comparator => :less_than_equal, :const_value => 0.15},
      :condition => { :var1 => "amount", :var2 => 0,
        :binaryoperator => "", :comparator => :less_than_equal,:const_value => 10000, :linking_operator => :and},
      :condition1 => { :var1 => "interest_rate", :var2 => 0,
        :binaryoperator => "", :comparator => :equal,:const_value => 0.15}}
   ...
   @loan = Loan.new(:amount => 10000, :interest_rate => 0.15, :installment_frequency => :weekly, :number_of_installments => 25, :scheduled_first_payment_date => "2000-12-06", :applied_on => "2000-02-01", :scheduled_disbursal_date => "2000-02-10")
  @loan.history_disabled = true
  @loan.applied_by       = @branch_manager
  @loan.approved_by      = @branch_manager
  @loan.disbursed_by     = @branch_manager
